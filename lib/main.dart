...
void main() => runApp(Naranjo());

class Naranjo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: EsScaffold(title: 'Flutter de Jose Miguel'),
    ); // fin de material
  } // fin de widget
} // fin de Naranjo
